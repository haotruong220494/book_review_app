...
10.times do |index|
  Post.create(account_id: 1, category_id: 1, author_id: 2, name: "Trinh thám #{index}", 
  	description: "Không chỉ trận này cựu ngôi sao Lisbon mới chứng minh vai trò của anh. Sự có mặt của tiền vệ sinh năm 1994 đã cứu cho Man Utd một mùa giải 2019-2020 có thể đã trở thành thảm họa. Anh đến Old Trafford hồi đầu tháng 2, nhưng chơi gần như mọi trận đấu có thể và không được nghỉ ngơi trong hành trình vào Top 3. Nhiều thời điểm chân chuyền 26 tuổi hụt hơi thấy rõ, nhưng HLV Solskjaer không dám cho anh ngồi ngoài.
		Tính từ khi cập bến Ngoại hạng Anh, Bruno đã ghi dấu giày vào 36 bàn sau 38 trận của Man Utd trên mọi đấu trường, với 22 bàn và 14 đường kiến tạo.",
